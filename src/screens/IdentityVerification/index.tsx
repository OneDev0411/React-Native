...
import { useSubmitApplicationMutation, useGetUserMutation } from '../../../redux/user/userApiSlice';
...
export default function IdentityVerification(props: any) {
	...
	const [applicationStatus, setApplicationStatus] = useState(
		props?.route?.params && 'applicationStatus' in props?.route?.params?.user == false
			? 'required'
	...
	const getCurrentUser = async () => {
		try {
			...
			setApplicationStatus(
				'applicationStatus' in resp?.data ? resp?.data?.applicationStatus : 'required'
			);
