...
export default function PartnerDetail(props: any) {
    ...
    const employeeData = useGetUserEmployeeWithIdQuery(uid);
    console.log(">>>>>>>>>>", employeeData.currentData);
    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView>
                ...
                <View style={{ width: "90%", alignSelf: "center", marginVertical: 15, alignContent: "center", alignItems: "center" }}>
                    <View style={{}}>
                        <Text style={{
                            fontSize: hp(2.8),
                            fontWeight: '400',
                    ...
                    <View style={{}}>
                        <Text style={{
                            ...
                            color: '#999',
                            textTransform: 'capitalize',
                        }}>{employeeData?.currentData?.email} - {employeeData?.currentData?.currency}</Text>
                ...
                <View style={styles.salesDataPointsContainer}>
                    <View style={styles.salesDataPointItem}>
                        ...
                        <Text style={styles.salesDataPointItemValue}>
                            {getCurrencySymbol(employeeData?.currentData.currency)} {""}
                            {formatNumber(employeeData?.currentData?.stats?.paid?.amount ?? 0)}
                        </Text>
                    </View>
                    ...
                    <View style={styles.salesDataPointItem}>
                        ...
                        >
                            {getCurrencySymbol(employeeData?.currentData.currency)} {""}
                            {formatNumber(employeeData?.currentData?.stats?.unpaid?.amount ?? 0)}
                        </Text>
                    </View>
                </View>
                ...
                <View>
                    {employeeData?.currentData?.sales.map((data, index) => (<>
                            ...
                            <View style={styles.listItemMiddle}>
                                <View style={styles.listStats}>
                                    <View
                                        style={{
                                            ...styles?.paidCard,
                                            width: data?.payment_link?.paid ? 42 : 66,
                                            backgroundColor: data?.payment_link?.paid
                                                ? `#2fbc362b`
                                                : `#d300152b`,
                                            borderWidth: 1,
                                            borderColor: data?.payment_link?.paid ? `#21c729` : `#ff0019`,
                                        }}
                                    >
                                        <Text
                                            style={{
                                                ...styles.paidText,
                                                color: data?.payment_link?.paid ? '#21c729' : '#ff0019',
                                            }}
                                        >
                                            {data?.payment_link?.paid ? 'Paid' : 'Not Paid'}
                                        </Text>
                                    </View>
                                    <Text style={styles.cardAmount}>· {data?.cards_amount} cards</Text>
                                </View>
