		...
		return (
			...
			>
				<View style={styles.rnModalBody}>
					<Image
						source={{
							uri: clientDetail?.image || 'https://orbis-alliance.com/wp-content/themes/consultix/images/no-image-found-360x260.png',
						}}
						style={{
							width: '100%',
							height: hp(20),
	...
	return (
		<>
			<View style={styles.container}>
				<Header title={'Sale Detail'} leftButton={() => props.navigation.goBack()} />
				{isLoading ? (
